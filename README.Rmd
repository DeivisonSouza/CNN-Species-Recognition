...
Este repositório guarda os arquivos (.Rmd, .R, .html) usados na palestra intitulada **"Reconhecimento de Espécies de Plantas Usando Recursos de Imagens: Um enfoque nas Redes Neurais Convolucionais (RNCs)"** ministrada pelo **Prof. Dr. Deivison Venicio Souza** para discentes de graduação em Engenharia Florestal e do Programa de Pós-Graduação em Engenharia Florestal da Universidade Federal do Paraná (UFPR) a convite da **Profa. Ana Paula Dalla Corte**.

# Slide da palestra

O slide da palestra síncrona intitulada **"Reconhecimento de Espécies de Plantas Usando Recursos de Imagens: Um enfoque nas Redes Neurais Convolucionais (RNCs)"** está disponível a seguir.
