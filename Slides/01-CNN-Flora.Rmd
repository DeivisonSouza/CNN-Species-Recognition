...
background-image: url(fig/LMFTCA.png), url(fig/ufpa.png), url(fig/PPGBC.png), url(fig/PPGCTIF.PNG), url(fig/capa.jpg)
...
<br>
## Redes Neurais Convolucionais (RNCs): Reconhecendo Espécies de Plantas a partir de Imagens
<br>
