...
.font90[
👉 .blue[Operação de Convolução?]
- É uma operação matemática que consiste na multiplicação de matrizes, porém de modo não convencional. 
- Na prática: 

👉 .blue[Kernels?]
- É uma pequena matriz quadrada com pesos 

👉 .blue[Kernels?]
- que desliza sobre a imagem da esquerda para a direita e de cima para baixo.

- Os pesos do *kernel* inciam com valores aleatórios e são aprendidos durante o treinamento da CNN.

Uma camada convolucional é composta por um conjunto de filtros (*kernels*), que deslizam sobre os dados de entrada.
- Cada *kernel* tem uma largura, uma altura e pesos usados para extrair recursos de imagens de entrada.
- Na etapa de treinamento, os pesos no *kernel* iniciam com valores aleatórios e são aprendidos com base no conjunto de treinamento.
<br>
]
]
