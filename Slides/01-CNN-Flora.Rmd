...
<br>
.center[**Tarefa**: .blue[Detecção de troncos de árvores e estimativa de diâmetro...]]
<br>
...
.pull-right-9[
.center[**Tarefa**: .blue[Detecção de copas de árvores (Mask R-CNN)]]
...
.pull-right-9[
<br><br>
.center[**Tarefa**: .blue[Detecção simultânea da altura e da copa da árvore (Mask R-CNN)]]
...
.center[**Tarefa**: .blue[Detecção de doenças em florestas de Pinus (Mask R-CNN) - VANT]]
...
.pull-left-9[
.font80[.center[**Imagens típicas de defeitos superficiais em madeira serrada...**]]
```{r , echo=FALSE, fig.show='hold', out.width='90%', fig.align='center'}
knitr::include_graphics('fig/wang.webp')
```
.center[.font80[**Fonte**: Wang et al., 2021]]
]
...
.blue[Avaliação da qualidade da superfície da madeira serrada...]

- a) Defeitos de nós sãos
- b) Defeitos de nós não sãos
- c) Defeitos de rachaduras
- d) Defeitos de furos de larvas
