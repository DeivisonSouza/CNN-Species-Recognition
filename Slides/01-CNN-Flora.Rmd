...
.shadow3[
.font80[
- **Sistema de reconhecimento**: Rede pré-treinada ResNet50 como extrator de recursos (*features*) + Classificador SVC
- **Acurácia**: 95% (de cada 100 imagens acerta 95)
- **Entrada**: Imagens digitais de cascas externas de árvores
]
]
...
---
## 🌳 DeepBark - Limitações e Desafios
