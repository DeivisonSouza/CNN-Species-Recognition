...
- .blue[**Importância**]: redução do **número de parâmetros treináveis e cálculos** da rede, tornando o modelo mais **rápido e eficiente**. Menos parâmetros ajuda reduzir **overfitting**. <br><br>
